...
export const mockedCourse = {
	id: 'b5630fdd-7bf7-4d39-b75a-2b5906fd0333',
	title: 'React',
...
export const mockedStateWithEmptyCourses = {
	user: {
		isAuth: true,
		name: 'Test Name',
	},
...
export const mockedStoreWithEmptyCourses = {
	getState: () => mockedStateWithEmptyCourses,
	subscribe: jest.fn(),
	dispatch: jest.fn(),
};
